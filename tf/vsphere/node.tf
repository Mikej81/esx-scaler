...
resource "vsphere_virtual_machine" "vm" {
  ...
  vapp {
    properties = {
      ...
      "guestinfo.interface.0.ip.0.address"        = var.node_address,
      ...
      "guestinfo.dns.server.0"                    = var.dns_primary,
      "guestinfo.dns.server.1"                    = var.dns_secondary,
      "guestinfo.ves.regurl"                      = "ves.volterra.io",
      "guestinfo.hostname"                        = var.nodename,
